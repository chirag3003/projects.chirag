  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Overview of your project management system</p>
      </div>
      ...
      <div className="grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Used for project organization</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Used for project filtering</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {projects.length > 0 ? `${Math.round((featuredProjects.length / projects.length) * 100)}%` : "0%"}
            </div>
            <p className="text-xs text-muted-foreground">Projects marked as featured</p>
          </CardContent>
        </Card>
      </div>
        ...
        <TabsContent value="featured" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Projects marked as featured on your site</CardDescription>
            </CardHeader>
            <CardContent>
