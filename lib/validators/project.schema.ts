...
export const projectRespSchema = z.object({
  project: projectSchema,
});

export type ProjectResp = z.infer<typeof projectRespSchema>;

export const projectsRespSchema = z.object({
  projects: z.array(projectSchema),
});
export type ProjectsResp = z.infer<typeof projectsRespSchema>;
